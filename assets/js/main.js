...
if (min_mm < 10) { min_mm = '0' + min_mm }
var min_aaaa = today.getFullYear()
var max_aaaa = today.getFullYear() +1
min_date = `${min_aaaa}-${min_mm}-${min_dd}`
max_date = `${max_aaaa}-${min_mm}-${min_dd}`
var x = document.getElementById('date').min = min_date
var y = document.getElementById('date').max = max_date
